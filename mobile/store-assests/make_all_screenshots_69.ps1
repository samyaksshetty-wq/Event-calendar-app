...
function New-StoreScreenshot {
    ...
    $headlineFont = New-Object System.Drawing.Font("Georgia", 74, [System.Drawing.FontStyle]::Bold)
    $subFont = New-Object System.Drawing.Font("Arial", 35, [System.Drawing.FontStyle]::Regular)
    ...
    $textRect = New-Object System.Drawing.RectangleF(62, 134, ($canvasW - 124), 329)
    $g.DrawString($Headline, $headlineFont, $headlineBrush, $textRect, $sf)

    $subRect = New-Object System.Drawing.RectangleF(93, 483, ($canvasW - 186), 144)
...
New-StoreScreenshot `
    ...
    -OutPath "$root\shot1_calendar_69.png" `
...
New-StoreScreenshot `
    ...
    -OutPath "$root\shot2_search_69.png" `
...
New-StoreScreenshot `
    ...
    -OutPath "$root\shot3_saved_69.png" `
...
New-StoreScreenshot `
    ...
    -OutPath "$root\shot4_details_69.png" `
...
New-StoreScreenshot `
    ...
    -OutPath "$root\shot5_festival_69.png" `
...
New-StoreScreenshot `
    ...
    -OutPath "$root\shot6_planahead_69.png" `
...
New-StoreScreenshot `
    ...
    -OutPath "$root\shot7_listevent_69.png" `
